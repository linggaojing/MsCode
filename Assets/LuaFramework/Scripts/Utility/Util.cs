...
namespace LuaFramework
{
    public class Util
    {
        ...
        public static void ClearMemory()
        {
            ...
            LuaManager mgr = GameManager.Instance.GetManager<LuaManager>(ManagerName.Lua);
            if (mgr != null)
                mgr.LuaGC();
        }
        ...
        public static string BuildAssetsPath {
            get
            {
                ...
                {
                    //直接把返回路径变成Asset同级目录
                    return Application.dataPath.Replace("Assets",AppConst.bundlePath+"/");
                }

                if (Application.platform == RuntimePlatform.WindowsPlayer)
                {
                    string[] paths = Application.dataPath.Split(new string[] { "app" }, StringSplitOptions.None);
                    return paths[0] + AppConst.bundlePath + "/";
                }
                ...
                return Application.dataPath + "/"+ AppConst.bundlePath + "/";
            }
        }
        ...
        public static string LogDataPath
        {
            get
            {
                return Util.BuildAssetsPath + "/log";
            }
        }
        ...
        public static string FrameworkRoot {
            get { return Application.dataPath + AppConst.rootName; }
        }
        ...
        //        Debug.Log("file://" + System.Environment.CurrentDirectory.Replace("\\", "/") + "/" + AppConst.AssetDir + "/");
        ...
        public static object[] CallMethod(string module, string func, params object[] args)
        {
            ...
            LuaManager luaMgr = GameManager.Instance.GetManager<LuaManager>(ManagerName.Lua);
            if (luaMgr == null)
                return null;
        ...
        public static int CheckRuntimeFile()
        {
            ...
            string streamDir = BuildAssetsPath;
            ...
            string sourceDir = FrameworkRoot + "/ToLua/Source/Generate/";
        ...
        public static GameObject NewObject(GameObject prefab)
        {
            if (prefab != null)
            {
