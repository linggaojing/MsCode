...
namespace LuaFramework
{
    public class ResourceManager : Manager
    {
        ...
        //Add防止出现两个协程加载同一个公用资源包
        List<string> TempLoadingAssetList = new List<string>();
        ...
        IEnumerator OnLoadAssetBundle(string abName, Type type)
        {
            ...
            else
            {
                ...
                if (dependencies.Length > 0)
                {
                    ...
                    for (int i = 0; i < dependencies.Length; i++)
                    {
                        ...
                        else if (!m_LoadRequests.ContainsKey(depName) && !TempLoadingAssetList.Contains(depName))
                        {
                            TempLoadingAssetList.Add(depName);
            ...
            if (assetObj != null)
            {
                ...
                if (TempLoadingAssetList.Contains(abName))
                    TempLoadingAssetList.Remove(abName);
            }
        }
