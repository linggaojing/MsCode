...
public class LuaFramework_PanelManagerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetCanvasParent", GetCanvasParent);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetCanvasParent(IntPtr L)
	{
		try
		{
			...
			LuaFramework.PanelManager obj = (LuaFramework.PanelManager)ToLua.CheckObject<LuaFramework.PanelManager>(L, 1);
			string arg0 = ToLua.CheckString(L, 2);
			UnityEngine.Transform o = obj.GetCanvasParent(arg0);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int CreateItem(IntPtr L)
	{
		try
		{
			...
			else if (count == 4)
			{
				...
				obj.CreateItem(arg0, arg1, arg2);
				return 0;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: LuaFramework.PanelManager.CreateItem");
			}
		}
		catch (Exception e)
		{
