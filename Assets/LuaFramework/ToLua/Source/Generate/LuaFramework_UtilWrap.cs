...
public class LuaFramework_UtilWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("BuildAssetsPath", get_BuildAssetsPath, null);
		L.RegVar("LogDataPath", get_LogDataPath, null);
	...
	static int DestroyGo(IntPtr L)
	{
		try
		{
			...
			LuaFramework.Util.DestroyGo(arg0);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int NewObject(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.CheckObject(L, 1, typeof(UnityEngine.GameObject));
			UnityEngine.GameObject o = LuaFramework.Util.NewObject(arg0);
			ToLua.PushSealed(L, o);
			return 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_BuildAssetsPath(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, LuaFramework.Util.BuildAssetsPath);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_LogDataPath(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, LuaFramework.Util.LogDataPath);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_FrameworkRoot(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, LuaFramework.Util.FrameworkRoot);
			return 1;
		}
		catch (Exception e)
		{
