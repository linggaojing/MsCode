...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Action<int,LuaFramework.ByteBuffer>), factory.System_Action_int_LuaFramework_ByteBuffer);
		...
		dict.Add(typeof(System.Action<string,UnityEngine.LogType>), factory.System_Action_string_UnityEngine_LogType);
		...
		DelegateTraits<System.Action<int,LuaFramework.ByteBuffer>>.Init(factory.System_Action_int_LuaFramework_ByteBuffer);
		...
		DelegateTraits<System.Action<string,UnityEngine.LogType>>.Init(factory.System_Action_string_UnityEngine_LogType);
		...
		TypeTraits<System.Action<int,LuaFramework.ByteBuffer>>.Init(factory.Check_System_Action_int_LuaFramework_ByteBuffer);
		...
		TypeTraits<System.Action<string,UnityEngine.LogType>>.Init(factory.Check_System_Action_string_UnityEngine_LogType);
		...
		StackTraits<System.Action<int,LuaFramework.ByteBuffer>>.Push = factory.Push_System_Action_int_LuaFramework_ByteBuffer;
		...
		StackTraits<System.Action<string,UnityEngine.LogType>>.Push = factory.Push_System_Action_string_UnityEngine_LogType;
	}
	...
	class System_Action_int_LuaFramework_ByteBuffer_Event : LuaDelegate
	{
		public System_Action_int_LuaFramework_ByteBuffer_Event(LuaFunction func) : base(func) { }
		public System_Action_int_LuaFramework_ByteBuffer_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(int param0, LuaFramework.ByteBuffer param1)
		{
			func.BeginPCall();
			func.Push(param0);
		...
		public void CallWithSelf(int param0, LuaFramework.ByteBuffer param1)
		{
			func.BeginPCall();
			func.Push(self);
			func.Push(param0);
	...
	public System.Action<int,LuaFramework.ByteBuffer> System_Action_int_LuaFramework_ByteBuffer(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<int,LuaFramework.ByteBuffer> fn = delegate(int param0, LuaFramework.ByteBuffer param1) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_int_LuaFramework_ByteBuffer_Event target = new System_Action_int_LuaFramework_ByteBuffer_Event(func);
			System.Action<int,LuaFramework.ByteBuffer> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_int_LuaFramework_ByteBuffer_Event target = new System_Action_int_LuaFramework_ByteBuffer_Event(func, self);
			System.Action<int,LuaFramework.ByteBuffer> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_int_LuaFramework_ByteBuffer(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<int,LuaFramework.ByteBuffer>), L, pos);
	}

	void Push_System_Action_int_LuaFramework_ByteBuffer(IntPtr L, System.Action<int,LuaFramework.ByteBuffer> o)
	{
		ToLua.Push(L, o);
	}
	...
	public System.Action<string,UnityEngine.LogType> System_Action_string_UnityEngine_LogType(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
		...
		if(!flag)
		{
			System_Action_string_UnityEngine_LogType_Event target = new System_Action_string_UnityEngine_LogType_Event(func);
			System.Action<string,UnityEngine.LogType> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_string_UnityEngine_LogType_Event target = new System_Action_string_UnityEngine_LogType_Event(func, self);
			System.Action<string,UnityEngine.LogType> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_string_UnityEngine_LogType(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<string,UnityEngine.LogType>), L, pos);
	}

	void Push_System_Action_string_UnityEngine_LogType(IntPtr L, System.Action<string,UnityEngine.LogType> o)
	{
		ToLua.Push(L, o);
	}
